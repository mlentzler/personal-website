...
const projects: Project[] = [
  {
    ...
    type: "Automation",
    description:
      "A high-performance bot designed to automatically monitor and book available time slots at the local vehicle registration office (Zulassungsstelle). It polls the appointment system and secures slots faster than manual interaction.",
