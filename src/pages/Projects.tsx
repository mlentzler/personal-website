...
export function Projects() {
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent) => {
    switch (e.key) {
      ...
      case 'Enter':
        if (introFinished) {
           if (selectedProject.liveUrl) window.open(selectedProject.liveUrl, '_blank');
           else if (selectedProject.githubUrl) window.open(selectedProject.githubUrl, '_blank');
        }
        break;
      case 'Backspace':
      case 'Escape':
  ...
  }, [navigate, introFinished, selectedProject]);
    ...
    <div className="flex flex-col w-full h-full font-mono text-cat-text select-none max-w-7xl mx-auto px-4 md:px-12">
      ...
      {introFinished && (
        <div className="flex-1 flex flex-col overflow-hidden animate-in fade-in duration-300 px-4 pb-4">
          <div className="flex-1 flex border border-cat-surface0 overflow-hidden rounded-sm shadow-2xl">
            
            {/* Sidebar */}
            <div className="w-80 border-r border-cat-surface0 p-0 flex flex-col bg-cat-mantle/10 shrink-0">
            ...
            <div className="flex-1 bg-cat-base p-10 overflow-y-auto scrollbar-thin scrollbar-thumb-cat-surface1 scrollbar-track-transparent">
              <div className="mb-6">
              ...
              <div className="mb-8">
                ...
                <div className="text-cat-text leading-relaxed text-[14px] whitespace-pre-line text-justify pr-4" dangerouslySetInnerHTML={{ __html: selectedProject.description }}>
                </div>
              </div>
