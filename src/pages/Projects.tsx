          ...
          <div className="flex-1 flex border border-cat-surface0 overflow-hidden rounded-sm shadow-2xl">
            ...
            <div className="flex-1 bg-cat-base p-10 overflow-y-auto scrollbar-thin scrollbar-thumb-cat-surface1 scrollbar-track-transparent">
              ...
              <div className="mb-8">
                ...
                <div
                  className="text-cat-text leading-relaxed text-[14px] whitespace-pre-line text-justify pr-4"
              ...
              {selectedProject.image && (
                <div className="mt-8 animate-in fade-in duration-700">
                  ...
                  <div
                    className={`border border-cat-surface0 rounded-sm overflow-hidden bg-cat-crust/50 group shadow-lg ${selectedProject.name === "MyRestaurantList" ? "max-w-[300px]" : "max-w-2xl"}`}
                  >
                    <img
